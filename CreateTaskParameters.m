...
%TaskParameters.GUI.ExperimentType = ExperimentType.SoundDiscrimination;
...
TaskParameters.GUIPanels.General = {'ExperimentType','ITI','RewardAmount','ChoiceDeadLine',...
    ...
    'StartEasyTrials','Percent50Fifty','PercentCatch','CatchError','Ports_LMRAudLRAir','Wire1VideoTrigger'};
%% StimDelay
...
TaskParameters.GUIPanels.SoundDiscrimination = {'LeftSoundAttenPrcnt','RightSoundAttenPrcnt'}
